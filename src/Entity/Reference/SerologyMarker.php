...
class SerologyMarker
{
    ...
    /** @var string[] Possible result values, e.g. ["+", "-"] or ["+", "-", "ND"] */
    ...
    public function setPossibleValues(array $possibleValues): static { $this->possibleValues = $possibleValues; return $this; }
