...
class ImmunologicalRisk
{
    ...
    public function getColorClass(): string { return $this->colorClass; }
    public function setColorClass(string $colorClass): static { $this->colorClass = $colorClass; return $this; }
